...
Связность между VM и Хостами как внутри одного пода так и между ними реализована. Отказоустойчивое подключение хостов выполнено. Поставленная задача выполнена.
